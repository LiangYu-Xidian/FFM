...
tag = "graph"  # 取哪种embeding方式
if tag == "graph":
    d = 7
if tag == "drug":
    d = 8

file_pos = pd.read_csv("D:/TASK3/Data/CancerDC/DrugComb/tissue/curr/Samples_final_guding/BRCA_breast.csv") 
file_neg = pd.read_csv("D:/TASK3/Data/CancerDC/DrugComb/tissue/curr/Samples_final_guding/BRCA_breast_neg.csv")  
...
Result.to_csv("D:/TASK3/Data/CancerDC/DrugComb/tissue/curr/Result/xgboost/Only_T/BRCA_breast.csv") ####
